...
function getRole() {
	...
	var url = ctx + '/role/role!addRole.htm';
	$.webAjax( {
		type : 'post',
		url : url,
		data : '' ,
...
function verifyForm() {
	...
	if(roleKey=='')
	{
		errorInfo('角色唯一KEY值不能为空');
		$('#roleKey').focus();
		return null;
	} 
	param['entity.roleName'] = roleName;
	param['entity.roleKey']=roleKey;
...
<form id="form">
            ...
            <div class="mr-content">
                ...
                <table id="cont_1" cellspacing="0" cellpadding="0" border="0" class="nobdTB">
                    ...
                    <tr>
                        <td align="right" width="120">角色KEY</td>
                        <td align="left">
                            <input type="text" class="inputall" id="roleKey" name="roleKey" />
                        </td>
                    </tr> 
                </table>
                <table id="cont_2" cellspacing="0" cellpadding="0" border="0" class="nobdTB" style="display:;">
                    ...
                    <tr >
                        <td align="left" ><ul id="authorityTree" class="ztree"></ul></td>
                    </tr>
                </table>
            </div>
