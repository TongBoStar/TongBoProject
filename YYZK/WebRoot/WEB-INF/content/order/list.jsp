...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/order/orderlist.js"></script>
<style type="text/css">
           ...
           <div id="page-wrapper">
			...
			<div class="portlet box portlet-grey">
				<div class="portlet-header">
					<div class="caption">
						<font style="margin-right:2px;font-size: 14px;">订单编号:</font><input id="optselect" class="input160" name="orderQuery.orderCode"/>
