...
$(document).ready(function() {
    $('#centergrid').datagrid({
    	url:'${ctx}/carapplication/car-application!myPageList.htm?carApplicationQuery.carState=${param.carState}',
        title: '用车申请列表',
        border: true,
        fit: true,
        singleSelect: true,
        ...
        columns: [[
            ...
            { field: 'number', title: '车牌号',
            	formatter: function (value, rec, index) {
            		if(rec.carInfo==undefined){
            			return "";
            		}else{
            			return rec.carInfo.number;
            		}
            	}
            },
            { field: 'name', title: '车辆名称',
            	formatter: function (value, rec, index) {
            		if(rec.carInfo==undefined){
            			...
            			return rec.carInfo.name;
            		}
            	}
            },
            { field: 'driver', title: '驾驶员' },
            { field: 'startTime', title: '申请起始时间' },
            { field: 'endTime', title: '申请结束时间' },
            { field: 'userOf', title: '用车人' },
            ...
            { field: 'userNumber', title: '用车人数' },
            { field: 'userMobilePhone', title: '联系方式' }
		]]
    });	
});
</script>
