...
$(function () {
	...
	$("#carId").change(function(){
		...
		if(carinfo.attributes.carInfoResList!=undefined){
...
function doprocess(ispass){
	if(ispass=="0"){
		...
		//同意
		if(taskName=="人事审核" || taskName=="等待还车"){
			myform.addRule([{
				ele:"#carId",
		        datatype:"*",
		        nullmsg:"请选择车辆！"
...
function overview(){
	$.dialog({
		content: 'url:${ctx}/oa/car/application/overview.htm',
		lock: true
	}).max();
}
</script>
					...
					<table class="my-table-form">
						<tr>
			      			...
			      			<td>
			        			...
			        			<a href="javascript:void(0);" onclick="overview();">用车预览</a>
			        		</td>
			        	</tr>
			        	<tr>
