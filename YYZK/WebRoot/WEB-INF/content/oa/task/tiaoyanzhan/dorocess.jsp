...
function doprocess(ispass){
	myform.eq(0).config({callback:function(form){
		$.ajax({
			type: "post",
			url: "${ctx}/tasktiaoyazhan/doProcess.htm?isPass="+ispass,
			data:$('#form').serialize(),
			dataType: "json",
			async: false,
	...
	<div class="my-tab-content">
		<div class="my-tab-area" style="display: block;">
			<form class="my-form" id="form" method="post">
				...
				<th class="my-w80">制令号</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.systemNumber" id="systemNumber" datatype="*" nullmsg="请填写制令号！" theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">单位名称</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.customerName" id="customerName" datatype="*" nullmsg="请填写单位名称！" theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">产品型号</th>
      			<td>
					<s:textarea name="taskTiaoYaZhan.productModel" id="productModel"  theme="simple" style="width:500px;height:60px;"></s:textarea>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">调压器型号</th>
      			<td>
					<s:textarea name="taskTiaoYaZhan.tiaoYaQiModel" id="tiaoYaQiModel"  theme="simple" style="width:500px;height:60px;"></s:textarea>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">进口压力</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.inPressure" id="inPressure"  theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">出口压力</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.outPressure" id="outPressure"  theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">过滤器令号或型号</th>
      			<td>
					<s:textarea name="taskTiaoYaZhan.filterNumber" id="filterNumber"  theme="simple" style="width:500px;height:60px;"></s:textarea>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">设备颜色</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.equipmentColor" id="equipmentColor"  theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">箱体</th>
      			<td>
        			<s:textfield name="taskTiaoYaZhan.boxColor" id="boxColor"  theme="simple" style="width: 300px;"></s:textfield>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">计划完成时间</th>
      			<td>
        			<input type="text" id="startTime" name="taskTiaoYaZhan.plannedFinishDate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:00'})" value="<s:date name="taskTiaoYaZhan.plannedFinishDate" format="yyyy-MM-dd HH:mm:ss"/>" style="width: 300px;" />
				</td>
        	</tr>
			<tr>
				<th class="my-w80">备注</th>
      			<td>
					<s:textarea name="taskTiaoYaZhan.remark" id="remark"  theme="simple" style="width:500px;height:60px;"></s:textarea>
        		</td>
        	</tr>
        	<tr>
				<th class="my-w80">设计人</th>
      			<td>
        			...
        			<s:hidden name="taskTiaoYaZhan.recipientId" id="recipientId" datatype="*" nullmsg="请选择设计人！" ></s:hidden>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="selRecipient()">选择</a>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">校验人</th>
      			<td>
        			...
        			<s:hidden name="taskTiaoYaZhan.jiaoYanId" id="jiaoYanId" datatype="*" nullmsg="请选择校验人！" ></s:hidden>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="selJiaoYan()">选择</a>
        		</td>
        	</tr>
			<tr>
				<th class="my-w80">审核人</th>
      			<td>
        			...
        			<s:hidden name="taskTiaoYaZhan.shenHeId" id="shenHeId" datatype="*" nullmsg="请选择审核人！" ></s:hidden>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="selShenHe()">选择</a>
        		</td>
        	</tr>
        	<tr>
			   				<th class="my-w80">批准</th>
			      			<td>
				...
				<s:hidden name="taskTiaoYaZhan.id" id="id"></s:hidden>
			</form>
		</div>
		<div class="my-tab-area" style="display: none;">
			<s:action name="historyDetailStepIndex" namespace="/process" executeResult="true"  ignoreContextParams="true"> 
				<s:param name="processInstanceId" value="taskTiaoYaZhan.processInstanceId"></s:param> 
			</s:action>
		</div>
		<div class="my-tab-area" style="display: none;">
