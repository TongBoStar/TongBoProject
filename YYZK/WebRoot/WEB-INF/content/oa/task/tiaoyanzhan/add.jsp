...
$(function(){
	var myform=$("#form").Validform({
		...
		callback:function(){
			$.ajax({
				type: "post",
				url: "${ctx}/tasktiaoyazhan/task-tiao-ya-zhan!save.htm",
				data:$('#form').serialize(),
				dataType: "json",
				async: false,
				beforeSend:function(){},
...
<form class="my-form" id="form" method="post">
	<div class="content-left">
		<div class="title-header">调压站信息添加</div>
		<table class="my-table-form">
			...
			<tr>
				<th class="my-w80"><span class="star">单位名称</span></th>
      			<td>
			...
			<tr>
				<th class="my-w80"><span class="star">计划完成时间</span></th>
      			<td>
        			<input type="text" id="startTime" name="taskTiaoYaZhan.plannedFinishDate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:00'})" value="<s:date name="taskTiaoYaZhan.plannedFinishDate" format="yyyy-MM-dd HH:mm:ss"/>" datatype="*" nullmsg="请选择计划完成时间！" style="width: 300px;" />
				</td>
        	</tr>
			<tr>
