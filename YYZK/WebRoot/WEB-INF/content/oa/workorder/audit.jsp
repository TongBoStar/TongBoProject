	...
	$('#form').form('submit',{
        onSubmit:function(){
            if($(this).form('enableValidation').form('validate')){
            	$.ajax({
    				type: "post",
    				url:'${ctx}/admin/oa/workorder/oa-work-order!audit.htm',
    				data:$('#form').serialize(),
    				dataType: "json",
    				async: false,
    				beforeSend:function(){},
					...
					<form id="form" method="post">
						...
						<table class="my-table-form">
				        	...
				        	<tr>
				      			...
				      			<td>
				      				<s:property value="oaWorkOrder.reason"/>
				        		</td>
				        	</tr>
				        	<tr>
				   				<th class="my-w80">解决方案</th>
				      			<td>
				      				<s:property value="oaWorkOrder.solution"/>
				        		</td>
				        	</tr>
				        	<tr>
				   				<th class="my-w80">工单状态</th>
				      			<td>
				      				<s:select theme="simple" list="#{1:'确认完成',-1:'关闭'}" cssStyle="width:80px;" cssClass="easyui-combobox" name="oaWorkOrder.workOrderStatus" id="workOrderStatus">
				      				</s:select>
				        		</td>
				        	</tr>
				        	<tr>
				   				<th class="my-w80">评价</th>
				      			<td>
				      				<s:textarea id="evaluate" name="oaWorkOrder.evaluate" theme="simple" style="width:400px;height:100%" data-options="multiline:true,required:true" cssClass="easyui-textbox"></s:textarea>
				        		</td>
				        	</tr>
