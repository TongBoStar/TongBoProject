...
$(document).ready(function() {
    $('#centergrid').datagrid({
    	url:'${ctx}/collection/collection!pageList.htm',
        title: '收藏列表',
        border: true,
        fit: true,
        singleSelect: true,
        ...
        columns: [[
            ...
            { field: 'priceAux', title: '价格' },
            { field: 'itemUserName', title: '手艺人名称' },
            { field: 'userName', title: '收藏人名称' },
            { field: 'createTime', title: '收藏时间' }
		]]
    });	
});
...
function show(id){
	$.dialog({
		content: 'url:${ctx}/meetingroomapplication/showIndex.htm?id='+id,
		lock: true,
		width:'1000px',
		height:'380px'
	});
