...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/course/unityobj.js"></script>
<style type="text/css">
...
<body id="bodymark">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
               <form name="queryForm" id="queryForm" action="" method="post" >
				<div class="portlet box portlet-grey">
					<div class="portlet-header">
						<div class="caption">
							<font style="margin-right:2px;font-size: 14px;">对象名称:</font><input name="unityobjQuery.sceneName" class="input160" placeholder="对象名称"/>
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="unityobjlistpage">
    ...
    <div id="inputDiv" class="affirmlayer" style="display: none; width: 520px;height: 230px;">
		...
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				...
				<table width="100%" class="my-table-form">
					<tbody>
						<tr>
					        <td align="right" width="20%">对象名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="objName" id="objName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					    ...
					    <tr>
					        <td align="right" width="20%">英文名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="enName" id="enName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
