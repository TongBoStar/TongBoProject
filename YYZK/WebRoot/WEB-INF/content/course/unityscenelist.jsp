...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/course/unityscene.js"></script>
<style type="text/css">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
               <form name="queryForm" id="queryForm" action="" method="post" >
				<div class="portlet box portlet-grey">
					<div class="portlet-header">
						<div class="caption">
							<font style="margin-right:2px;font-size: 14px;">场景名称:</font><input name="unitysceneQuery.sceneName" class="input160" placeholder="场景名称"/>
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="unityscenelistpage">
		...
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				...
				<table width="100%" class="my-table-form">
					<tbody>
						<tr>
					        <td align="right" width="20%">场景名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="sceneName" id="sceneName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					        <td align="right" width="20%">场景序号：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="fseq" id="fseq" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					        <td align="right" width="20%">场景标识：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="sceneCode" id="sceneCode" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					     <tr>
					        <td align="right" width="20%">场景图标：</td>
					        <td width="70%" style="text-align:left;">
								<div style="float:right;"><input name="upload" id="resourceIcon" type="file"/></div>
								<div>
									<input type="hidden" name="resourceIcon" id="filepath"/>
					     ...
					     <tr>
					        <td align="right" width="20%">解锁状态：</td>
					        <td width="70%" style="text-align:left;">
					        	<select id="fstatus" name="fstatus" class="select120" style="width:80%;">
					        		<option value="0">锁定</option><option value="1">解锁</option>
					        	</select>
					        </td>
					        <td width="10%"></td>
					     </tr>
					     <tr>
					        <td align="right" width="20%">场景描述：</td>
					        <td width="70%" style="text-align:left;">
					        	<textarea id="fmark" name="fmark" class="textareaall_noborder" rows="3" cols="10" style="width:80%;"></textarea>
					        </td>
					        <td width="10%"></td>
					     </tr>
					</tbody>
