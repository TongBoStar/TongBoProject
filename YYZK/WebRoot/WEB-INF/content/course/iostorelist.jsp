...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/course/iostore.js"></script>
<style type="text/css">
...
<body id="bodymark">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
               ...
               <input type="hidden" name="iostoreQuery.dataType" value="${param.dataType }"/>
				<div class="portlet box portlet-grey">
					<div class="portlet-header">
						<div class="caption">
							<font style="margin-right:2px;font-size: 14px;">物料编码:</font><input name="iostoreQuery.itemCode" class="input160"/>
							<font style="margin-right:2px;font-size: 14px;">物料名称:</font><input name="iostoreQuery.itemName" class="input160"/>
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="iostorelistpage">
    ...
    <div id="inputDiv" class="affirmlayer" style="display: none; width: 520px;height: 355px;">
		<h2 style="font-family: 微软雅黑;">
			<b id="dataTypeb">出入库信息</b>
			<a href="#" onclick="closeDiv('inputDiv');" style="float:right;font-size: 18px;"><i class="fa fa-times-circle"></i></a>
		</h2>
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				<input type="hidden" name="id" id="hiddenId"/>
				<input type="hidden" name="dataType" id="dataTypeHidden" value="${param.dataType }"/>
				<table width="100%" class="my-table-form">
					<tbody>
						...
						<tr>
					        ...
					        <td width="70%" style="text-align:left;">
					        	<input id="itemName" class="input160" onkeyup="toAddItemName();" onclick="toAddItemName();" style="width:80%;"/>
					    ...
					    <tr>
					        <td align="right" width="20%">规格型号：</td>
					        <td width="70%" style="text-align:left;">
					        	<input id="itemMode" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					    ...
					    <tr>
					        <td align="right" width="20%">序列号：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="serialNumber" id="serialNumber" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					    ...
					    <tr>
					        <td align="right" width="20%" id="trType">出库类型：</td>
					        <td width="70%" style="text-align:left;">
					        	<select class="select120" style="width:80%;" id="ftype" name="ftype"><option value="1">成品</option><option value="2">零件</option></select>
					        </td>
					        <td width="10%"></td>
					    </tr>
					     <tr>
