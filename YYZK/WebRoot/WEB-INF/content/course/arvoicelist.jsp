...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/course/arvoice.js"></script>
<style type="text/css">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
               <form name="queryForm" id="queryForm" action="" method="post" >
				<div class="portlet box portlet-grey">
					<div class="portlet-header">
						<div class="caption">
							<font style="margin-right:2px;font-size: 14px;">音频名称:</font><input name="arvoiceQuery.voiceName" class="input160" placeholder="音频名称"/>
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="arvoicelistpage">
		...
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				...
				<table width="100%" class="my-table-form">
					<tbody>
						<tr>
					        <td align="right" width="20%">音频名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="voiceName" id="voiceName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					        <td align="right" width="20%">音频别名：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="actionName" id="actionName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					    <tr>
					     ...
					     <tr>
					        <td align="right" width="20%">音频路径：</td>
					        <td width="70%" style="text-align:left;">
								<div style="float:right;"><input name="upload" id="voicePath" type="file"/></div>
								<div>
									<input type="hidden" name="voicePath" id="filepath"/>
