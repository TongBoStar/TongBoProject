...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/adminjs/activityinfo.js"></script>
<style type="text/css">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
               <form name="queryForm" id="queryForm" action="" method="post" >
				<div class="portlet box portlet-grey">
					<div class="portlet-header">
						<div class="caption">
							<font style="margin-right:2px;font-size: 14px;">活动名称:</font><input name="activityInfoQuery.activityName" class="input160" placeholder="活动名称"/>
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="activityinfolistpage">
		...
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				...
				<table width="100%" class="my-table-form">
					<tbody>
						<tr>
					        <td align="right" width="20%">活动名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="activityName" id="activityName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
						<tr>
					        ...
					        <td width="70%" style="text-align:left;">
					        	<select id="activityType" name="activityType" class="input120" style="width:80%;">
					        		<option value="1">下单打折</option>
					        		<option value="2">下单立减</option>
					        		<option value="3">下单立变</option>
					        		<option value="4">新人专享</option>
					        		<option value="5">秒杀</option>
					        		<option value="6">抽奖</option>
					        		<option value="7">拼单</option>
					        	</select>
					        </td>
					        <td width="10%"></td>
					     </tr>
						<tr>
					        <td align="right" width="20%">金额(折扣率)：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="activityPrice" id="activityPrice" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					     </tr>
					     <tr>
