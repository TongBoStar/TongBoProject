...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/adminjs/activityitem.js"></script>
<style type="text/css">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="activityitemlistpage">
