...
<script type="text/javascript" src="${ctx}/sysresources/custom/applicationjs/adminjs/moduleimg.js"></script>
<style type="text/css">
...
<body id="bodymark">
       ...
       <div id="wrapper">
           ...
           <div id="page-wrapper">
			...
			<div class="pages" style="position:fixed;bottom:2px;">            		
			   	<div class="ps-right">            	
				   	<simpletable:pageToolbar page="${page}" id="moduleimglistpage">
    ...
    <div id="inputDiv" class="affirmlayer" style="display: none; width: 520px;height: 240px;">
		...
		<div style="height: auto;">
			<form id="inputForm" name="inputForm">
				...
				<table width="100%" class="my-table-form">
					<tbody>
						<tr>
					        <td align="right" width="20%">轮播图名称：</td>
					        <td width="70%" style="text-align:left;">
					        	<input name="moduleImgName" id="moduleImgName" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					    </tr>
					     <tr>
					        ...
					        <td width="70%" style="text-align:left;">
					        	<input name="toUrl" id="toUrl" class="input160" style="width:80%;"/>
					        </td>
					        <td width="10%"></td>
					     </tr>
						<tr>
					        <td align="right" width="20%">所属模块：</td>
					        <td width="70%" style="text-align:left;">
					        	<select id="moduleId" name="moduleId" class="select120" style="width:80%;"></select>
					        </td>
					        <td width="10%"></td>
					     </tr>
					     <tr>
