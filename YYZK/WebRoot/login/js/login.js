$(document).ready(function() {
	...
	}else if($('#errorinput').val()=='2'){
		 $('#randCode').attr('placeholder','请输入正确的验证码!');
	}else{}
	$("#j_username").attr("nullmsg",pleaseinutusername);
	$("#j_username").attr("title",username);
	
	$("#j_password").attr("nullmsg",pleaseinutpassword);
	$("#j_password").attr("title",password);
...
function refreshValidateCode(ctx){
	$('#validateCodeImg').attr("src",ctx+"/common/validateCodeServlet?id="+Math.random());
}