...
function changePCode(){
    ...
    if(null!=itemcodeSelect){
    	//alert("itemcodeSelect:"+itemcodeSelect);
     var itemPcode=itemcodeSelect.substring(0, itemcodeSelect.lastIndexOf('.'));
     //alert("itemPcode:"+itemPcode);
     document.getElementById("newitemPcode").value=itemPcode;
    }
}
function changePCode2(newitemcodeForOptItem){
    var itemcodeSelect=document.getElementById(newitemcodeForOptItem).value;
    if(null!=itemcodeSelect){
    	//alert("itemcodeSelect:"+itemcodeSelect);
     var itemPcode=itemcodeSelect.substring(0, itemcodeSelect.lastIndexOf('.'));
     //alert("itemPcode:"+itemPcode);
     document.getElementById("newitemPcodeForOptItem").value=itemPcode;
    }
}
