...
function search()
{
	...
	//var url = ctx+"/rpBill/rp-bill!findPageStatistic.htm";
	var url = ctx+"/rpBill/rp-bill!findStatisticPage.htm";
		...
		$.refreshPageToolbar(page,"rppage",simpleTable);
			if(data.resultInfo[0]=='0')
			{
				$.each(page.result,function(i,o){
					...
					html+='<td>'+(o.fanaitem==null?"":o.fanaitem)+'</td>';
...
function addRpbill(){
	//添加跳转链接
	window.open('/receivable/rpbill-add.htm');
}
//跳转到统计销售人员业绩奖数据列表
