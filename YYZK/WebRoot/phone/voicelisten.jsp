...
body { background: url(voicelisten/css/006.jpg);transform: scale(0.7); }
...
.music-player > .dash{
  ...
  left: 0;
  height: 300px;
  background: url(voicelisten/css/image_png_00001.png) center bottom repeat-x;
}
.music-player > .dash > a{
  display: block;
  position: absolute;
...
.music-player > .dash > .seeker > .wheel > .progress{
  ...
  background: url(voicelisten/css/image_png_00003.png);
...
<script src="voicelisten/js/prefixfree.min.js"></script>
</head>
<body>
...
<input value="${param.serialNumber }" id="serialNumber" type="hidden"/>
<input value="${param.filepath }" id="filepath" type="hidden"/>
  <img src="voicelisten/css/image_png_00002.png" class="album" />
  <div class="dash">
...
<script src='voicelisten/js/jquery_and_jqueryui.js'></script>
<script src="voicelisten/js/index.js"></script>
