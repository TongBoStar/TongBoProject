...
function openchild(id){
	$('#img1').attr("src","images1/tobottom.png");
	var html = "";
	html += '<tr id="idd1">';
    html += '	 <td></td>';
    html += '    <td>1</td>';
...
<table class="zebra">
    <thead>
    <tr>
    	<th style="text-align: center;" width="15%">展开</th>
        <th style="text-align: center;"width="5%">#</th>        
        <th style="text-align: center;"width="30%">ID号</th>
	...
	<tbody>	
    <!-- <tr id="id1">
    	<td><img src="images1/toright.png" id="img1" style="width:15px;height:15px;" onclick="openchild(1);"/></td>
        <td>1</td> 
        <td>111</td>
        <td>YQ000051</td>
        <td>3</td>
    ...
    <tr>
    	<td><img src="images1/toright.png" style="width:15px;height:15px;"/></td>
        <td>2</td> 
        <td>222</td>
        <td>YQ000052</td>
        <td>3</td>
