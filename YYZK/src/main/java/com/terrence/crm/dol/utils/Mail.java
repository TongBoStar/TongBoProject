...
public class Mail { 
	...
	public static void main(String[] args){
		...
		/* String smtp = "smtp.163.com";
	        String username="abtianliyuan@163.com";
	        String password="ohblue123456,.;";
	        String from = "abtianliyuan@163.com";
	        String[] to = {"abtianliyuan@qq.com"};*/
		
		String smtp = "smtp.163.com";
		
		String from = "abtianliyuan@163.com";
		String to = "tlynewcity@163.com";
		
		String copyto = "tlynewcity@163.com";
		
		String subject = "关于开会的通知";
		String content = "关于开会的通知";
