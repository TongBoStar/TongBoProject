 ...
 * @param <PK> 主键
 */
public abstract class BaseIbatisDao<E, PK extends Serializable> extends SqlMapClientDaoSupport implements IBaseDao<E, PK> {
	...
	public E getById(PK primaryKey) {
        E object = (E) getSqlMapClientTemplate().queryForObject(getFindByPrimaryKeyStatement(), primaryKey);
        return object;
    }
    @SuppressWarnings("unchecked")
	public E getById(String statement,PK primaryKey) {
        E object = (E) getSqlMapClientTemplate().queryForObject(statement, primaryKey);
        return object;
    }
    ...
    {
    	 E object = (E) getSqlMapClientTemplate().queryForObject(statement, query);
         return object;
    }
	/* (non-Javadoc)
	...
	public Integer deleteByMultipleId(String ids) throws DataAccessException {
		return getSqlMapClientTemplate().delete(getDeleteMultipleStatement(), ids);
	}
	/*
	 * (non-Javadoc)
	 * @see com.terrence.productschedule.dol.base.IBaseDao#deleteByMultipleId(java.lang.String, java.lang.String)
	 */
	...
	public PK save(E entity) {
		...
		return (PK) getSqlMapClientTemplate().insert(getInsertStatement(), entity);    	
    }
	...
	/*
	 * (non-Javadoc)
	 * @see com.terrence.productschedule.dol.base.IBaseDao#update(java.lang.String, java.lang.Object)
	 */
...
//	}
    ...
    public Page<E> findPageStatisticInfo(final Page<E> page, final BaseQuery query) {
		Assert.notNull(page, "page不能为空");

		if (page.isAutoCount()) {
			//自定义的
			Number totalCount = (Number) getSqlMapClientTemplate()
					.queryForObject("RpBill.findPage.statistic.count",query);
		...
		if(page.getPageNo()!=1)
		{
			query.setNotTop("top "+page.getPageSize()*(page.getPageNo()-1));
		}
...
//		otherFilters.put("sortColumns", sortColumns);
		...
		List result = getSqlMapClientTemplate().queryForList(getFindPageStatement(), query, (int)page.getCurrentFirst()-1, page.getPageSize());
		page.setResult(result);
		return page;
	}
    public Page<E> findStatisticPage(final Page<E> page, final BaseQuery query) {
		Assert.notNull(page, "page不能为空");

		if (page.isAutoCount()) {
			Number totalCount = (Number) getSqlMapClientTemplate()
					.queryForObject("RpBill.findStatisticPage.count",query);
			page.setTotalCount(totalCount.longValue());
		}
...
//		otherFilters.put("sortColumns", sortColumns);
		...
		List result = getSqlMapClientTemplate().queryForList("RpBill.findStatisticPage", 
				query, (int)page.getCurrentFirst()-1, page.getPageSize());
		page.setResult(result);
		return page;
	}
	/* (non-Javadoc)
	 * @see com.disney.dol.base.IBaseDao#findPage(com.disney.dol.base.core.Page, java.lang.String, com.disney.dol.base.BaseQuery)
	 */
	@SuppressWarnings("unchecked")
	public Page<E> findPage(final Page<E> page, final BaseQuery query) {
		...
		if (page.isAutoCount()) {
			Number totalCount = (Number) getSqlMapClientTemplate().queryForObject(getCountStatementForPaging(getFindPageStatement()),query);
			page.setTotalCount(totalCount.longValue());
		}
...
//		otherFilters.put("sortColumns", sortColumns);
	 ...
	 * @see com.disney.dol.base.IBaseDao#findPage(com.disney.dol.base.core.Page, java.lang.String, com.disney.dol.base.BaseQuery)
	 */
	public Page<E> findPage(final Page<E> page, final String statement,final BaseQuery query) {
		Assert.notNull(page, "page不能为空");

		if (page.isAutoCount()) {
			Number totalCount = (Number) getSqlMapClientTemplate().queryForObject(statement+".count",query);
			page.setTotalCount(totalCount.longValue());
		}
...
//		otherFilters.put("sortColumns", sortColumns);
		...
		List result = getSqlMapClientTemplate().queryForList(statement, query, (int)page.getCurrentFirst()-1, page.getPageSize());
		page.setResult(result);
		return page;
	}
	...
	public List<E> findList(final BaseQuery query) throws DataAccessException {
		return getSqlMapClientTemplate().queryForList(getFindListStatement(), query);
	}
	/*
	 * (non-Javadoc)
	 * @see com.disney.dol.base.IBaseDao#findList(com.disney.dol.base.BaseQuery, java.lang.Integer)
	 */
	@SuppressWarnings("unchecked")
	public List<E> findList(final BaseQuery query,Integer pageSize) throws DataAccessException {
		return getSqlMapClientTemplate().queryForList(getFindListStatement(), query,0,pageSize);
	}
	@SuppressWarnings("unchecked")
	public List<E> findList(final BaseQuery query,String statement,Integer pageSize) throws DataAccessException {
		return getSqlMapClientTemplate().queryForList(statement, query,0,pageSize);
	}
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see com.disney.dol.base.IBaseDao#isUnique(com.disney.dol.base.BaseQuery, java.lang.String, java.lang.String, java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public boolean isUnique(final BaseQuery query, final String uniquePropertyNames, final Object newValue, final Object oldValue) throws DataAccessException, IllegalAccessException, InvocationTargetException {
		...
		List<E> result = getSqlMapClientTemplate().queryForList(getFindListStatement(), query);
    ...
    {
    	return getSqlMapClientTemplate().delete(statement, query);
    }
}
