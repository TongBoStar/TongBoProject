...
public interface IBaseDao<E, PK extends Serializable> {
	 ...
	 *             the data access exception
	 */
	public PK save(final E entity, final String statement)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public Integer update(final String statement, final E entity)
			throws DataAccessException;
	...
	public Page<E> findPage(final Page<E> page, final String statement,
			final BaseQuery query) throws DataAccessException;
